...
public class WJCyclePictureView: UIView {
    ...
    open var autoScrollDelay: TimeInterval = 0.1
...
extension WJCyclePictureView: UIScrollViewDelegate {
...
extension WJCyclePictureView: UICollectionViewDelegate, UICollectionViewDataSource {
