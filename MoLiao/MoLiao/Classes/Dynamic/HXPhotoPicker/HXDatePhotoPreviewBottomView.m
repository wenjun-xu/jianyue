...
- (void)layoutSubviews {
    ...
    self.bgView.tintColor = [UIColor redColor];
...
//        _tipView.hidden = YES;
        _tipView.translucent = NO;
        [_tipView setBackgroundImage:[UIImage imageNamed:@"导航@2x.png"] forToolbarPosition:UIToolbarPositionAny barMetrics:UIBarMetricsDefault];
...
//        _doneBtn.backgroundColor = self.manager.configuration.themeColor;
        _doneBtn.backgroundColor = [UIColor greenColor];
