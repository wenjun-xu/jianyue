...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return CGSizeMake((kWidth - 2*CellSpacing)/4.0, SegmentHeaderViewHeight - 1);
}
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        _collectionView.backgroundColor = [UIColor colorWithRed:240/255.0 green:239/255.0 blue:244/255.0 alpha:1];
...
- (UIView *)separator {
    if (!_separator) {
        ...
        _separator.backgroundColor = [UIColor colorWithRed:240/255.0 green:239/255.0 blue:244/255.0 alpha:1];
    }
    return _separator;
}
