...
#import "ConverListViewController.h"
...
@interface ConverListViewController ()<EaseConversationListViewControllerDelegate, EaseConversationListViewControllerDataSource>

@property (nonatomic, strong) UIView *networkStateView;

@end

@implementation ConverListViewController
            ...
            didSelectConversationModel:(id<IConversationModel>)conversationModel
{
    if (conversationModel) {
        ...
        if (conversation) {
            EaseMessageViewController *viewController = [[EaseMessageViewController alloc] initWithConversationChatter:conversation.conversationId conversationType:conversation.type];
...
- (id<IConversationModel>)conversationListViewController:(EaseConversationListViewController *)conversationListViewController  modelForConversation:(EMConversation *)conversation{
    ...
    if (model.conversation.type == EMConversationTypeChat) {
        ...
        if(dic[@"nickname"] == nil || dic[@"avatar"] == nil){
            ...
            //头像占位图
            model.avatarImage = [UIImage imageNamed:@"meinv"];
        }else{
            model.title = dic[@"nickname"];
            model.avatarURLPath = dic[@"avatar"];
            //头像占位图
            model.avatarImage = [UIImage imageNamed:@"imageDownloadFail"];
        }
