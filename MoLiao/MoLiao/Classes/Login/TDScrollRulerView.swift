...
class TDScrollRulerView: UIView {
    ...
    ///   - strokeColor: 卡尺颜色
    public init(frame: CGRect, strokeColor: UIColor, middleLineColor: UIColor, min: CGFloat, max: CGFloat, part: Int = 5, step: Int = 10, unit: String = "", numFontSize: CGFloat, endNum: CGFloat, endText: String, endTextColor: UIColor, endtextFontSize: CGFloat) {
        super.init(frame: frame)
    ...
    func reloadRulerView(min: CGFloat, max: CGFloat, part: Int = 5, step: Int = 10, unit: String = "", numFontSize: CGFloat, endNum: CGFloat, endText: String, endTextColor: UIColor, endtextFontSize: CGFloat) {
