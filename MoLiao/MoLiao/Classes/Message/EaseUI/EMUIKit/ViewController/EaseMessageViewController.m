...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"dict==================%@",dict);
    model.avatarURLPath = [dict objectForKey:@"avatar"];
    
     model.nickname = [dict objectForKey:@"nickname"];
//    [sendCell.avatarView sd_setImageWithURL:[NSURL URLWithString:model.avatarURLPath] placeholderImage:model.avatarImage];
...
//    NSDictionary *ext = @{@"accountName":@"oldDriver",@"img":@"http://ww4.sinaimg.cn/bmiddle/005Kg81Agw1f7gel4rm4oj30hs0hst9j.jpg"};
    ...
    NSDictionary *ext = @{@"avatar":headUrlImage,@"nickname":bianNickName};
...
- (id<IMessageModel>)messageViewController:(EaseMessageViewController *)viewController
    ...
    if (model.isSender) {//自己发送
        ...
        //头像占位图
        model.avatarImage = [UIImage imageNamed:@"shuaige"];
