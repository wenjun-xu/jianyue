...
- (instancetype)initWithFrame:(CGRect)frame imageNameArray:(NSArray<NSString *> *)imageNameArray buttonIsHidden:(BOOL)isHidden {
    if ([super initWithFrame:frame]) {
        ...
        [skipButton setTitleColor:[UIColor colorWithWhite:0.333 alpha:0.9] forState:UIControlStateNormal];
        [skipButton setBackgroundColor:[UIColor colorWithWhite:0.900 alpha:0.9]];
        ...
        self.imagePageControl.currentPageIndicatorTintColor = [UIColor redColor];
